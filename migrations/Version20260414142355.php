 ...
 */
final class Version20260414142355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER subscription_date DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD department VARCHAR(100) NOT NULL');
        ...
        $this->addSql('ALTER TABLE "user" ALTER subscription_date SET NOT NULL');
